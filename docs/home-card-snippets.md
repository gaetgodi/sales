...
<a href="/services/" class="gdi-card">
  ...
  <p>Looking for custom development, a legacy site migration, or a ready-to-go recipe platform? See how the free-discovery process works, what migrating an aging site actually involves, and the club/event tools — scheduling, photo galleries — available to license on their own.</p>
...
<a href="/work/" class="gdi-card">
  ...
  <p>Want proof, not promises? Real case studies you can click into — a system that's run for ten years, a full site migration, an active pickleball club platform — each with a live sandbox you can try yourself, not just read about.</p>
...
<a href="/about/" class="gdi-card">
  ...
  <p>Curious how this actually works? Sixty years of programming experience and a research career, and the simple idea behind every project: understand the business first, then build the software.</p>
...
<a href="/event-photography/" class="gdi-card">
  ...
  <p>Need a photographer for your next event? See real photos from a real reunion, a photo booth with live background effects, group photos done right, and how pricing actually works.</p>
