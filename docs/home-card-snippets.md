...
<a href="/services/" class="gdi-card">
  ...
  <p>See how the free-discovery process works, what migrating an aging site actually involves, and the club/event tools — scheduling, photo galleries — available to license on their own.</p>
...
<a href="/work/" class="gdi-card">
  ...
  <p>Real case studies you can click into — a system that's run for ten years, a full site migration, an active pickleball club platform — each with a live sandbox you can try yourself, not just read about.</p>
...
<a href="/about/" class="gdi-card">
  ...
  <p>Years spent building application software that real companies relied on to manage and run their operations — now channeled into bringing that same kind of business application online, so it's accessible from anywhere. The idea behind every project stays the same: understand the business first, then build the software.</p>
...
<a href="/event-photography/" class="gdi-card">
  ...
  <p>See real photos from a real reunion, a photo booth with live background effects, group photos done right, and how pricing actually works.</p>
